...
using LVBeerTap.ApiServices;
using LVBeerTap.ApiServices.Security;
using LVBeerTap.Documentation.Installers;
using LVBeerTap.WebApi.Handlers;
using LVBeerTap.WebApi.Hypermedia;
using LVBeerTap.WebApi.Infrastructure.Installers;
using LVBeerTap.Model;
using IQ.Platform.Framework.WebApi.Infrastructure;

namespace LVBeerTap.WebApi.Infrastructure
{
    ...
    public class DefaultApiContainer : ApiContainer
    {
        ...
        {
            return
                _windsorContainer.Resolve<ApiSecurityContextProvidingHandler<LVBeerTapApiUser, NullUserContext>>();
        }
